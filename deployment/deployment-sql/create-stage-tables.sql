CREATE TABLE IF NOT EXISTS public.yellow_cab_tripdata_staging (
...
CREATE TABLE IF NOT EXISTS public.green_cab_tripdata_staging (
    dwid VARCHAR NOT NULL,                      
    vendor_id INTEGER,
    pickup_datetime TIMESTAMP NOT NULL,           
    dropoff_datetime TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.fhv_cab_tripdata_staging (
    dwid VARCHAR NOT NULL,      
