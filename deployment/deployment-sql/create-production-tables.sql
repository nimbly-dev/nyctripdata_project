CREATE TABLE IF NOT EXISTS public.yellow_cab_tripdata_production (
...
CREATE TABLE IF NOT EXISTS public.green_cab_tripdata_production (
    dwid VARCHAR NOT NULL,                      
    vendor_id INTEGER,
    pickup_datetime TIMESTAMP NOT NULL,           
    dropoff_datetime TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.fhv_cab_tripdata_production (
    dwid VARCHAR NOT NULL,      
