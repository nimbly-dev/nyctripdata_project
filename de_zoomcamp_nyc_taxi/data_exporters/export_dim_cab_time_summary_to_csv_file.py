...
def export_data_to_file(df: pd.DataFrame, **kwargs) -> None:
    ...
    with Postgres.with_config(ConfigFileLoader(config_path, config_profile)) as loader:
        ...
        query_to_get_time_summary_cabs = "SELECT * FROM dim.dim_time_summary_mv;"
        

        get_time_summary_df = loader.load(query_to_get_time_summary_cabs)
    
    filepath = '/home/src/de_zoomcamp_nyc_taxi/resources/csv/dim_cab_time_summary_cabs.csv'
    get_time_summary_df.to_csv(filepath, index=False)
