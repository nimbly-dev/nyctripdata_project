...
def export_data_to_file(df: pd.DataFrame, **kwargs) -> None:
    ...
    with Postgres.with_config(ConfigFileLoader(config_path, config_profile)) as loader:
        ...
        query_to_get_time = "SELECT * FROM dim.dim_time_mv;"
        

        get_time_df = loader.load(query_to_get_time)
    
    filepath = '/home/src/de_zoomcamp_nyc_taxi/resources/csv/dim_cab_time.csv'
    get_time_df.to_csv(filepath, index=False)
