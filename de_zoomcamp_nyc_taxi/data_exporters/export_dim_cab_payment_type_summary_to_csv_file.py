...
def export_data_to_file(df: pd.DataFrame, **kwargs) -> None:
    ...
    with Postgres.with_config(ConfigFileLoader(config_path, config_profile)) as loader:
        ...
        query_to_get_dropoff_summary = "SELECT * FROM dim.dim_cab_payment_type_summary_mv;"
        

        payment_summary_df = loader.load(query_to_get_dropoff_summary)
    
    filepath = '/home/src/de_zoomcamp_nyc_taxi/resources/csv/dim_cab_payment_type_summary.csv'
    payment_summary_df.to_csv(filepath, index=False)
