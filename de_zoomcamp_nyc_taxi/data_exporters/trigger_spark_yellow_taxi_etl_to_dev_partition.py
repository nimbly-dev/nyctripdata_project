...
def trigger(*args, **kwargs):
    ...
    parrelel_exc_count = kwargs['parrelel_exc_count']
    ...
    with ThreadPoolExecutor(max_workers=parrelel_exc_count) as executor:
        for year in range(start_year, end_year + 1):
            for month in range(1, 13):
                ...
                # Submit the trigger_pipeline call as a task to the executor.
                tasks.append(
                    executor.submit(
                        trigger_pipeline,
        ...
        # Wait for all tasks to complete and raise exceptions if any occur.
