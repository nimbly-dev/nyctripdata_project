...
def export_data_to_file(df: pd.DataFrame, **kwargs) -> None:
    ...
    with Postgres.with_config(ConfigFileLoader(config_path, config_profile)) as loader:
        ...
        query_to_get_vendor_summary = "SELECT * FROM dim.dim_cab_vendor_type_summary_mv;"
        

        vendor_summary_df = loader.load(query_to_get_vendor_summary)
    
    filepath = '/home/src/de_zoomcamp_nyc_taxi/resources/csv/dim_cab_vendor_type_summary.csv'
    vendor_summary_df.to_csv(filepath, index=False)
