...
@custom
def export_dim_cab_pickup_location_summary(df: pd.DataFrame, *args, **kwargs):
    ...
    csv_filepath = os.path.join(user_code_path, "resources", "csv", "dim_cab_pickup_location_summary.csv")
