...
@custom
def export_dim_cab_payment_type_summary(df: pd.DataFrame, **kwargs) -> None:
    ...
    csv_filepath = os.path.join(user_code_path, "resources", "csv", "dim_cab_payment_type_summary.csv")
