...
def load_data_from_postgres(*args, **kwargs):
    ...
    SELECT EXISTS (
        ...
        AND table_name = 'green_cab_tripdata_production_{year_month}'
    )
    """
    ...
    with Postgres.with_config(ConfigFileLoader(config_path, config_profile)) as loader:
        try:
            ...
            if not table_exists or 'green' not in get_data_from:
                LOG.info(f"Table public.green_cab_tripdata_production_{year_month} does not exist.")
