...
def load_data_from_postgres(*args, **kwargs):
    ...
    SELECT EXISTS (
        ...
        AND table_name = 'yellow_cab_tripdata_production_{year_month}'
    )
    """
    ...
    FROM 
        public.yellow_cab_tripdata_production_{year_month}
    """
    ...
    with Postgres.with_config(ConfigFileLoader(config_path, config_profile)) as loader:
        try:
            ...
            if not table_exists or 'yellow' not in get_data_from:
                print(f"Table public.yellow_cab_tripdata_production_{year_month} does not exist.")
