...
def load_data_from_postgres(*args, **kwargs):
    ...
    staging_viewtemp_table = table_name + '_view'
    df.createOrReplaceTempView(staging_viewtemp_table)
    filtered_df = spark.sql(f"""
        SELECT * FROM {staging_viewtemp_table}
    ...
    spark.catalog.dropTempView(staging_viewtemp_table)
